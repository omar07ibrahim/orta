...
<svg xmlns="http://www.w3.org/2000/svg" width="1600" height="920" viewBox="0 0 1600 920" role="img" aria-labelledby="title desc">
  ...
  <desc id="desc">Two independent Node workers serialize workflow writes through SQLite WAL while a read-only verifier independently replays events and compares the projection and ledger head.</desc>
  <style>
  ...
  <text x="70" y="116" class="sub">Implemented boundary — HTTP routes remain deliberately disconnected</text>
  ...
  <rect x="70" y="650" width="305" height="160" rx="20" fill="#fff3d4" stroke="#c58a18" stroke-width="2"/>
  <text x="105" y="705" class="h">HTTP routes</text><text x="105" y="747" class="p">legacy SQL path</text><text x="105" y="782" class="mono">workflow opt-in: OFF</text>
